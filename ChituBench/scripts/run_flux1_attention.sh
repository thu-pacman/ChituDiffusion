...
EXPERIMENT_ID="flux1_dev_attention"
...
PLOT_TITLE="Flux1-dev Attention Backend Trade-off"
CONTACT_TITLE="Flux1-dev Attention Backend Visual Check"
...
run_case origin_flash "$BENCH_DIR/configs/flux1_dev/attention/origin_flash.yaml"
run_case torch_sdpa_math "$BENCH_DIR/configs/flux1_dev/attention/torch_sdpa_math.yaml"
run_case sage "$BENCH_DIR/configs/flux1_dev/attention/sage.yaml"
run_case sparge "$BENCH_DIR/configs/flux1_dev/attention/sparge.yaml"
