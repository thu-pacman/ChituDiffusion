...
EXPERIMENT_ID="flux2_klein_attention"
...
PLOT_TITLE="Flux2-klein-4B Attention Backend Trade-off"
CONTACT_TITLE="Flux2-klein-4B Attention Backend Visual Check"

PROMPT_FILE="${CHITUBENCH_PROMPT_FILE:-$BENCH_DIR/prompts/flux2_klein_attention.json}"
...
run_case origin_flash "$BENCH_DIR/configs/flux2_klein/attention/origin_flash.yaml"
run_case torch_sdpa_math "$BENCH_DIR/configs/flux2_klein/attention/torch_sdpa_math.yaml"
run_case sage "$BENCH_DIR/configs/flux2_klein/attention/sage.yaml"
run_case sparge "$BENCH_DIR/configs/flux2_klein/attention/sparge.yaml"
