...
| **Z-Image** FlexCache | Runtime、单卡 FlashAttention、MeanCache、FreeCache replay 与 TracePlanner 探索已接入 | [→](ChituBench/configs/z_image/flexcache/base_flash.yaml) |
...
| **Z-Image** FlexCache | Runtime path, single-GPU FlashAttention, MeanCache, FreeCache replay, and TracePlanner probes are integrated | [→](ChituBench/configs/z_image/flexcache/base_flash.yaml) |
