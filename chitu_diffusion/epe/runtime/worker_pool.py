...
class SingletonLaneWorkerPool:
    """Asynchronous producer-consumer pool for the width-one EPE limit.
...
class FullWorldLaneWorkerPool:
    ...
    A completed request is replaced immediately without opening an EPE pulse.
    """
