...
from chitu_diffusion.epe.runtime.timeline import RankTimelineRecorder
from chitu_diffusion.epe.runtime.worker_pool import AsyncResultChannel, LaneWorkResult
from chitu_diffusion.serve.protocol import ImageGenerateRequest
from chitu_diffusion.serve.runtime import (
...
def test_lane_releases_before_cpu_postprocess_completes(tmp_path) -> None:
    ...
    runtime = object.__new__(DiffusionServiceRuntime)
